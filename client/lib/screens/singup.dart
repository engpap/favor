...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  UpdateFieldsStatus(ErrorMessage response){
    ...
    (_textControllerSurname == "") ? _StatusSurname = "error" : _StatusSurname = "valid";
    //cambiare assulutamente questo controllo
    (_textControllerEmail == "") ? _StatusEmail = "error" : _StatusEmail = "valid";
    (_textControllerPassword == "") ? _StatusPassword = "error" : _StatusPassword = "undefined";
    (_textControllerPasswordConfirm == "") ? _StatusPasswordConfirm = "error" : _StatusPasswordConfirm = "undefined";
                        ...
                        child: SizedBox(
                          ...
                          child: CupertinoButton(
                            ...
                            onPressed: () {
                              ...
                              Future<ErrorMessage> signupResponse = _authService.signup(
