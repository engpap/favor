...
class AdminScreen_T extends StatefulWidget {
  const AdminScreen_T({super.key});

  @override
  State<AdminScreen_T> createState() => _AdminScreen_TState();
}

class _AdminScreen_TState extends State<AdminScreen_T> {
  Set<Marker> _markers = {};
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 10,),
                customHeading2(heading: "Districts"),
                Expanded(
                  child: FutureBuilder<Statistics?>(
                      future: statistics,
                      builder: ((context, snapshot) {
